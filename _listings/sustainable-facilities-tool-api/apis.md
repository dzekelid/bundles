...
- name: Sustainable Facilities Tool API
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery/bundles/master/_listings/sustainable-facilities-tool-api/building-systems-system-bundles-get.md
x-common:
- type: x-developer
